 ...
 (function($) {
        ...
        $.fn.jTPS = function ( opt ) {
                ...
                var pT = $(this), page = page || 1, perPages = $(this).data('tableSettings').perPages, perPage = perPage || perPages[0],
                        rowCount = $('>tbody', this).find('tr').length;//el -4 le he agregado para que siempre me esta agregando 4 filas mas al final.
                        ...
                        function () {
                                ...
                                $(this).bind('click',
                                        function () {
                                                ...
                                                $('>.nav .status', pT).html( 'Visualizando ' + ( cPos + 1 ) + '   -   ' + ( cPos + ePos ) + ' de ' + rowCount + '' );
                                                clearSelection();
                                                // callback function after pagination renderd
                                                $(pT).data('tableSettings').clickCallback();
                                        }
                ...
                $('>.nav .status', this).html( 'Visualizando ' + ( cPos + 1 ) + '   -   ' + ( cPos + ePos ) + ' de ' + rowCount );
