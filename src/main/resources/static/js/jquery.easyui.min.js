...
},loader:function(_aa9,_aaa,_aab){
var opts=$(this).combobox("options");
if(!opts.url){
return false;
}
...
return data;
},finder:{getEl:function(_aac,_aad){
var _aae=_a51(_aac,_aad);
var id=$.data(_aac,"combobox").itemIdPrefix+"_"+_aae;
return $("#"+id);
},getGroupEl:function(_aaf,_ab0){
var _ab1=$.data(_aaf,"combobox");
var _ab2=$.easyui.indexOfArray(_ab1.groups,"value",_ab0);
var id=_ab1.groupIdPrefix+"_"+_ab2;
return $("#"+id);
},getGroup:function(_ab3,p){
var _ab4=$.data(_ab3,"combobox");
var _ab5=p.attr("id").substr(_ab4.groupIdPrefix.length+1);
return _ab4.groups[parseInt(_ab5)];
},getRow:function(_ab6,p){
var _ab7=$.data(_ab6,"combobox");
var _ab8=(p instanceof $)?p.attr("id").substr(_ab7.itemIdPrefix.length+1):_a51(_ab6,p);
return _ab7.data[parseInt(_ab8)];
}},onBeforeLoad:function(_ab9){
},onLoadSuccess:function(data){
},onLoadError:function(){
},onSelect:function(_aba){
},onUnselect:function(_abb){
},onClick:function(_abc){
}});
})(jQuery);
(function($){
function _abd(_abe){
var _abf=$.data(_abe,"combotree");
var opts=_abf.options;
var tree=_abf.tree;
$(_abe).addClass("combotree-f");
$(_abe).combo($.extend({},opts,{onShowPanel:function(){
if(opts.editable){
tree.tree("doFilter","");
}
opts.onShowPanel.call(this);
}}));
var _ac0=$(_abe).combo("panel");
if(!tree){
tree=$("<ul></ul>").appendTo(_ac0);
_abf.tree=tree;
}
tree.tree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
var _ac1=$(_abe).combotree("getValues");
if(opts.multiple){
$.map(tree.tree("getChecked"),function(node){
$.easyui.addArrayItem(_ac1,node.id);
});
}
_ac6(_abe,_ac1,_abf.remainText);
...
_abf.remainText=false;
_ac3(_abe);
opts.onClick.call(this,node);
},onCheck:function(node,_ac2){
_abf.remainText=false;
_ac3(_abe);
opts.onCheck.call(this,node,_ac2);
}}));
};
function _ac3(_ac4){
...
_ac6(_ac4,vv,_ac5.remainText);
};
function _ac6(_ac7,_ac8,_ac9){
var _aca=$.data(_ac7,"combotree");
var opts=_aca.options;
var tree=_aca.tree;
var _acb=tree.tree("options");
var _acc=_acb.onBeforeCheck;
var _acd=_acb.onCheck;
var _ace=_acb.onSelect;
_acb.onBeforeCheck=_acb.onCheck=_acb.onSelect=function(){
};
if(!$.isArray(_ac8)){
_ac8=_ac8.split(opts.separator);
}
if(!opts.multiple){
_ac8=_ac8.length?[_ac8[0]]:[""];
}
var vv=$.map(_ac8,function(_acf){
return String(_acf);
});
...
ss.push(_ad1(v,opts.mappingRows)||v);
...
_acb.onBeforeCheck=_acc;
_acb.onCheck=_acd;
_acb.onSelect=_ace;
if(!_ac9){
var s=ss.join(opts.separator);
if($(_ac7).combo("getText")!=s){
$(_ac7).combo("setText",s);
}
}
$(_ac7).combo("setValues",vv);
function _ad1(_ad2,a){
var item=$.easyui.getArrayItem(a,"id",_ad2);
return item?_ad0(item):undefined;
};
function _ad0(node){
return node[opts.textField||""]||node.text;
};
};
function _ad3(_ad4,q){
var _ad5=$.data(_ad4,"combotree");
var opts=_ad5.options;
var tree=_ad5.tree;
_ad5.remainText=true;
tree.tree("doFilter",opts.multiple?q.split(opts.separator):q);
};
function _ad6(_ad7){
var _ad8=$.data(_ad7,"combotree");
_ad8.remainText=false;
$(_ad7).combotree("setValues",$(_ad7).combotree("getValues"));
$(_ad7).combotree("hidePanel");
};
$.fn.combotree=function(_ad9,_ada){
if(typeof _ad9=="string"){
var _adb=$.fn.combotree.methods[_ad9];
if(_adb){
return _adb(this,_ada);
}else{
return this.combo(_ad9,_ada);
}
}
_ad9=_ad9||{};
return this.each(function(){
var _adc=$.data(this,"combotree");
if(_adc){
$.extend(_adc.options,_ad9);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_ad9)});
}
_abd(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _add=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{width:_add.width,height:_add.height,originalValue:_add.originalValue,disabled:_add.disabled,readonly:_add.readonly});
},clone:function(jq,_ade){
var t=jq.combo("clone",_ade);
...
},setValues:function(jq,_adf){
return jq.each(function(){
var opts=$(this).combotree("options");
if($.isArray(_adf)){
_adf=$.map(_adf,function(_ae0){
if(_ae0&&typeof _ae0=="object"){
$.easyui.addArrayItem(opts.mappingRows,"id",_ae0);
return _ae0.id;
}else{
return _ae0;
}
...
},setValue:function(jq,_ae1){
return jq.each(function(){
$(this).combotree("setValues",$.isArray(_ae1)?_ae1:[_ae1]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotree.parseOptions=function(_ae2){
return $.extend({},$.fn.combo.parseOptions(_ae2),$.fn.tree.parseOptions(_ae2));
};
...
var grid=_ae5.grid;
$(_ae4).addClass("combogrid-f").combo($.extend({},opts,{onShowPanel:function(){
_afa(this,$(this).combogrid("getValues"),true);
var p=$(this).combogrid("panel");
var _ae6=p.outerHeight()-p.height();
var _ae7=p._size("minHeight");
var _ae8=p._size("maxHeight");
var dg=$(this).combogrid("grid");
dg.datagrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_ae7?_ae7-_ae6:""),maxHeight:(_ae8?_ae8-_ae6:"")});
...
var _ae9=$(_ae4).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_ae9);
_ae5.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,singleSelect:(!opts.multiple),onLoadSuccess:_aea,onClickRow:_aeb,onSelect:_aec("onSelect"),onUnselect:_aec("onUnselect"),onSelectAll:_aec("onSelectAll"),onUnselectAll:_aec("onUnselectAll")}));
function _aed(dg){
return $(dg).closest(".combo-panel").panel("options").comboTarget||_ae4;
};
function _aea(data){
var _aee=_aed(this);
var _aef=$(_aee).data("combogrid");
var opts=_aef.options;
var _af0=$(_aee).combo("getValues");
_afa(_aee,_af0,_aef.remainText);
opts.onLoadSuccess.call(this,data);
};
function _aeb(_af1,row){
var _af2=_aed(this);
var _af3=$(_af2).data("combogrid");
var opts=_af3.options;
_af3.remainText=false;
_af4.call(this);
if(!opts.multiple){
$(_af2).combo("hidePanel");
}
opts.onClickRow.call(this,_af1,row);
};
function _aec(_af5){
return function(_af6,row){
var _af7=_aed(this);
var opts=$(_af7).combogrid("options");
if(_af5=="onUnselectAll"){
if(opts.multiple){
_af4.call(this);
}
}else{
...
opts[_af5].call(this,_af6,row);
};
};
function _af4(){
var dg=$(this);
var _af8=_aed(dg);
var _af9=$(_af8).data("combogrid");
var opts=_af9.options;
var vv=$.map(dg.datagrid("getSelections"),function(row){
return row[opts.idField];
});
vv=vv.concat(opts.unselectedValues);
_afa(_af8,vv,_af9.remainText);
};
};
function nav(_afb,dir){
var _afc=$.data(_afb,"combogrid");
var opts=_afc.options;
var grid=_afc.grid;
var _afd=grid.datagrid("getRows").length;
if(!_afd){
return;
}
...
var _afe;
if(!tr.length){
_afe=(dir=="next"?0:_afd-1);
}else{
var _afe=parseInt(tr.attr("datagrid-row-index"));
_afe+=(dir=="next"?1:-1);
if(_afe<0){
_afe=_afd-1;
}
...
if(opts.selectOnNavigation){
_afc.remainText=false;
grid.datagrid("selectRow",_afe);
}
};
function _afa(_aff,_b00,_b01){
var _b02=$.data(_aff,"combogrid");
var opts=_b02.options;
var grid=_b02.grid;
var _b03=$(_aff).combo("getValues");
var _b04=$(_aff).combo("options");
var _b05=_b04.onChange;
_b04.onChange=function(){
};
var _b06=grid.datagrid("options");
var _b07=_b06.onSelect;
var _b08=_b06.onUnselectAll;
_b06.onSelect=_b06.onUnselectAll=function(){
};
if(!$.isArray(_b00)){
_b00=_b00.split(opts.separator);
}
if(!opts.multiple){
_b00=_b00.length?[_b00[0]]:[""];
}
var vv=$.map(_b00,function(_b09){
return String(_b09);
});
vv=$.grep(vv,function(v,_b0a){
return _b0a===$.inArray(v,vv);
});
var _b0b=$.grep(grid.datagrid("getSelections"),function(row,_b0c){
return $.inArray(String(row[opts.idField]),vv)>=0;
});
grid.datagrid("clearSelections");
grid.data("datagrid").selectedRows=_b0b;
var ss=[];
opts.unselectedValues=[];
$.map(vv,function(v){
var _b0d=grid.datagrid("getRowIndex",v);
if(_b0d>=0){
grid.datagrid("selectRow",_b0d);
}else{
opts.unselectedValues.push(v);
}
ss.push(_b0e(v,grid.datagrid("getRows"))||_b0e(v,_b0b)||_b0e(v,opts.mappingRows)||v);
});
$(_aff).combo("setValues",_b03);
_b04.onChange=_b05;
_b06.onSelect=_b07;
_b06.onUnselectAll=_b08;
if(!_b01){
var s=ss.join(opts.separator);
if($(_aff).combo("getText")!=s){
$(_aff).combo("setText",s);
}
}
$(_aff).combo("setValues",_b00);
...
q=$.trim(q);
var _b14=q;
_b15(opts.mappingRows,q);
_b15(grid.datagrid("getSelections"),q);
var _b16=_b15(rows,q);
if(_b16>=0){
if(opts.reversed){
grid.datagrid("highlightRow",_b16);
}
}else{
...
function _b17(_b18){
var _b19=$.data(_b18,"combogrid");
var opts=_b19.options;
var grid=_b19.grid;
var tr=opts.finder.getTr(grid[0],null,"highlight");
_b19.remainText=false;
if(tr.length){
var _b1a=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_b1a);
}else{
...
$(_b18).combogrid("setValues",vv);
if(!opts.multiple){
$(_b18).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_b1b,_b1c){
if(typeof _b1b=="string"){
var _b1d=$.fn.combogrid.methods[_b1b];
if(_b1d){
return _b1d(this,_b1c);
}else{
return this.combo(_b1b,_b1c);
}
}
_b1b=_b1b||{};
return this.each(function(){
var _b1e=$.data(this,"combogrid");
if(_b1e){
$.extend(_b1e.options,_b1b);
}else{
_b1e=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_b1b)});
}
_ae3(this);
});
};
$.fn.combogrid.methods={options:function(jq){
var _b1f=jq.combo("options");
return $.extend($.data(jq[0],"combogrid").options,{width:_b1f.width,height:_b1f.height,originalValue:_b1f.originalValue,disabled:_b1f.disabled,readonly:_b1f.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
if($.isArray(_b20)){
_b20=$.map(_b20,function(_b21){
if(_b21&&typeof _b21=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.idField,_b21);
return _b21[opts.idField];
}else{
return _b21;
}
});
...
},setValue:function(jq,_b22){
return jq.each(function(){
$(this).combogrid("setValues",$.isArray(_b22)?_b22:[_b22]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combogrid.parseOptions=function(_b23){
var t=$(_b23);
return $.extend({},$.fn.combo.parseOptions(_b23),$.fn.datagrid.parseOptions(_b23),$.parser.parseOptions(_b23,["idField","textField","mode"]));
};
...
var _b24=e.data.target;
var opts=$(_b24).combogrid("options");
if(opts.reversed){
$(_b24).combogrid("setValues",$(_b24).combogrid("getValues"));
}
...
(function($){
function _b25(_b26){
var _b27=$.data(_b26,"combotreegrid");
var opts=_b27.options;
$(_b26).addClass("combotreegrid-f").combo($.extend({},opts,{onShowPanel:function(){
var p=$(this).combotreegrid("panel");
var _b28=p.outerHeight()-p.height();
var _b29=p._size("minHeight");
var _b2a=p._size("maxHeight");
var dg=$(this).combotreegrid("grid");
dg.treegrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_b29?_b29-_b28:""),maxHeight:(_b2a?_b2a-_b28:"")});
...
if(!_b27.grid){
var _b2b=$(_b26).combo("panel");
_b27.grid=$("<table></table>").appendTo(_b2b);
}
_b27.grid.treegrid($.extend({},opts,{border:false,checkbox:opts.multiple,onLoadSuccess:function(row,data){
var _b2c=$(_b26).combotreegrid("getValues");
if(opts.multiple){
$.map($(this).treegrid("getCheckedNodes"),function(row){
$.easyui.addArrayItem(_b2c,row[opts.idField]);
});
}
_b31(_b26,_b2c);
opts.onLoadSuccess.call(this,row,data);
_b27.remainText=false;
},onClickRow:function(row){
if(opts.multiple){
...
},onCheckNode:function(row,_b2d){
_b2e(_b26);
opts.onCheckNode.call(this,row,_b2d);
}}));
};
function _b2e(_b2f){
var _b30=$.data(_b2f,"combotreegrid");
...
var _b34=$.data(_b32,"combotreegrid");
...
var vv=$.map(_b33,function(_b35){
return String(_b35);
});
vv=$.grep(vv,function(v,_b36){
return _b36===$.inArray(v,vv);
});
var _b37=grid.treegrid("getSelected");
if(_b37){
grid.treegrid("unselect",_b37[opts.idField]);
}
...
ss.push(_b39(v,opts.mappingRows)||v);
opts.unselectedValues.push(v);
}
});
if(opts.multiple){
...
if(!_b34.remainText){
var s=ss.join(opts.separator);
if($(_b32).combo("getText")!=s){
$(_b32).combo("setText",s);
}
}
$(_b32).combo("setValues",vv);
function _b39(_b3a,a){
var item=$.easyui.getArrayItem(a,opts.idField,_b3a);
return item?_b38(item):undefined;
};
function _b38(row){
...
var grid=_b3d.grid;
_b3d.remainText=true;
grid.treegrid("clearSelections").treegrid("clearChecked").treegrid("highlightRow",-1);
if(opts.mode=="remote"){
$(_b3c).combotreegrid("clear");
...
$.fn.combotreegrid=function(_b40,_b41){
if(typeof _b40=="string"){
var _b42=$.fn.combotreegrid.methods[_b40];
if(_b42){
return _b42(this,_b41);
}else{
return this.combo(_b40,_b41);
}
}
_b40=_b40||{};
return this.each(function(){
var _b43=$.data(this,"combotreegrid");
if(_b43){
$.extend(_b43.options,_b40);
}else{
_b43=$.data(this,"combotreegrid",{options:$.extend({},$.fn.combotreegrid.defaults,$.fn.combotreegrid.parseOptions(this),_b40)});
}
_b25(this);
});
};
$.fn.combotreegrid.methods={options:function(jq){
var _b44=jq.combo("options");
return $.extend($.data(jq[0],"combotreegrid").options,{width:_b44.width,height:_b44.height,originalValue:_b44.originalValue,disabled:_b44.disabled,readonly:_b44.readonly});
},grid:function(jq){
return $.data(jq[0],"combotreegrid").grid;
},setValues:function(jq,_b45){
return jq.each(function(){
var opts=$(this).combotreegrid("options");
if($.isArray(_b45)){
_b45=$.map(_b45,function(_b46){
if(_b46&&typeof _b46=="object"){
$.easyui.addArrayItem(opts.mappingRows,opts.idField,_b46);
return _b46[opts.idField];
}else{
return _b46;
}
});
...
},setValue:function(jq,_b47){
return jq.each(function(){
$(this).combotreegrid("setValues",$.isArray(_b47)?_b47:[_b47]);
});
},clear:function(jq){
return jq.each(function(){
...
$.fn.combotreegrid.parseOptions=function(_b48){
var t=$(_b48);
return $.extend({},$.fn.combo.parseOptions(_b48),$.fn.treegrid.parseOptions(_b48),$.parser.parseOptions(_b48,["mode",{limitToGrid:"boolean"}]));
};
...
var _b49=e.data.target;
var opts=$(_b49).combotreegrid("options");
if(opts.limitToGrid){
_b3e(_b49);
}
}}),filter:function(q,row){
...
(function($){
function _b4a(_b4b){
var _b4c=$.data(_b4b,"tagbox");
var opts=_b4c.options;
$(_b4b).addClass("tagbox-f").combobox($.extend({},opts,{cls:"tagbox",reversed:true,onChange:function(_b4d,_b4e){
_b4f();
$(this).combobox("hidePanel");
opts.onChange.call(_b4b,_b4d,_b4e);
},onResizing:function(_b50,_b51){
var _b52=$(this).combobox("textbox");
var tb=$(this).data("textbox").textbox;
tb.css({height:"",paddingLeft:_b52.css("marginLeft"),paddingRight:_b52.css("marginRight")});
_b52.css("margin",0);
tb._size({width:opts.width},$(this).parent());
_b65(_b4b);
_b57(this);
opts.onResizing.call(_b4b,_b50,_b51);
},onLoadSuccess:function(data){
_b4f();
...
_b65(_b4b);
function _b4f(){
$(_b4b).next().find(".tagbox-label").remove();
var _b53=$(_b4b).tagbox("textbox");
var ss=[];
$.map($(_b4b).tagbox("getValues"),function(_b54,_b55){
var row=opts.finder.getRow(_b4b,_b54);
var text=opts.tagFormatter.call(_b4b,_b54,row);
var cs={};
var css=opts.tagStyler.call(_b4b,_b54,row)||"";
if(typeof css=="string"){
cs={s:css};
}else{
cs={c:css["class"]||"",s:css["style"]||""};
}
var _b56=$("<span class=\"tagbox-label\"></span>").insertBefore(_b53).html(text);
_b56.attr("tagbox-index",_b55);
_b56.attr("style",cs.s).addClass(cs.c);
$("<a href=\"javascript:;\" class=\"tagbox-remove\"></a>").appendTo(_b56);
});
_b57(_b4b);
$(_b4b).combobox("setText","");
};
};
function _b57(_b58,_b59){
var span=$(_b58).next();
var _b5a=_b59?$(_b59):span.find(".tagbox-label");
if(_b5a.length){
var _b5b=$(_b58).tagbox("textbox");
var _b5c=$(_b5a[0]);
var _b5d=_b5c.outerHeight(true)-_b5c.outerHeight();
var _b5e=_b5b.outerHeight()-_b5d*2;
_b5a.css({height:_b5e+"px",lineHeight:_b5e+"px"});
var _b5f=span.find(".textbox-addon").css("height","100%");
_b5f.find(".textbox-icon").css("height","100%");
...
var opts=$(_b61).tagbox("options");
if(opts.disabled||opts.readonly){
return;
}
if($(e.target).hasClass("tagbox-remove")){
var _b62=parseInt($(e.target).parent().attr("tagbox-index"));
var _b63=$(_b61).tagbox("getValues");
if(opts.onBeforeRemoveTag.call(_b61,_b63[_b62])==false){
return;
}
opts.onRemoveTag.call(_b61,_b63[_b62]);
_b63.splice(_b62,1);
$(_b61).tagbox("setValues",_b63);
}else{
var _b64=$(e.target).closest(".tagbox-label");
if(_b64.length){
var _b62=parseInt(_b64.attr("tagbox-index"));
var _b63=$(_b61).tagbox("getValues");
opts.onClickTag.call(_b61,_b63[_b62]);
}
}
...
function _b65(_b66){
var opts=$(_b66).tagbox("options");
var _b67=$(_b66).tagbox("textbox");
var span=$(_b66).next();
var tmp=$("<span></span>").appendTo("body");
tmp.attr("style",_b67.attr("style"));
tmp.css({position:"absolute",top:-9999,left:-9999,width:"auto",fontFamily:_b67.css("fontFamily"),fontSize:_b67.css("fontSize"),fontWeight:_b67.css("fontWeight"),whiteSpace:"nowrap"});
var _b68=_b69(_b67.val());
var _b6a=_b69(opts.prompt||"");
tmp.remove();
var _b6b=Math.min(Math.max(_b68,_b6a)+20,span.width());
_b67._outerWidth(_b6b);
span.find(".textbox-button").linkbutton("resize",{height:"100%"});
function _b69(val){
...
if(opts.limitToList){
var _b6e=t.tagbox("panel");
var item=_b6e.children("div.combobox-item-hover");
if(item.length){
item.removeClass("combobox-item-hover");
var row=opts.finder.getRow(_b6d,item);
var _b6f=row[opts.valueField];
$(_b6d).tagbox(item.hasClass("combobox-item-selected")?"unselect":"select",_b6f);
}
$(_b6d).tagbox("hidePanel");
}else{
var v=$.trim($(_b6d).tagbox("getText"));
if(v!==""){
var _b70=$(_b6d).tagbox("getValues");
_b70.push(v);
$(_b6d).tagbox("setValues",_b70);
}
}
};
function _b71(_b72,_b73){
$(_b72).combobox("setText","");
_b65(_b72);
$(_b72).combobox("setValues",_b73);
$(_b72).combobox("setText","");
$(_b72).tagbox("validate");
};
$.fn.tagbox=function(_b74,_b75){
if(typeof _b74=="string"){
var _b76=$.fn.tagbox.methods[_b74];
if(_b76){
return _b76(this,_b75);
}else{
return this.combobox(_b74,_b75);
}
}
_b74=_b74||{};
return this.each(function(){
var _b77=$.data(this,"tagbox");
if(_b77){
$.extend(_b77.options,_b74);
}else{
$.data(this,"tagbox",{options:$.extend({},$.fn.tagbox.defaults,$.fn.tagbox.parseOptions(this),_b74)});
}
_b4a(this);
_b60(this);
});
...
var _b78=jq.combobox("options");
return $.extend($.data(jq[0],"tagbox").options,{width:_b78.width,height:_b78.height,originalValue:_b78.originalValue,disabled:_b78.disabled,readonly:_b78.readonly});
},setValues:function(jq,_b79){
return jq.each(function(){
_b71(this,_b79);
});
}};
$.fn.tagbox.parseOptions=function(_b7a){
return $.extend({},$.fn.combobox.parseOptions(_b7a),$.parser.parseOptions(_b7a,[]));
};
$.fn.tagbox.defaults=$.extend({},$.fn.combobox.defaults,{hasDownArrow:false,multiple:true,reversed:true,selectOnNavigation:false,tipOptions:$.extend({},$.fn.textbox.defaults.tipOptions,{showDelay:200}),val:function(_b7b){
var vv=$(_b7b).parent().prev().tagbox("getValues");
if($(_b7b).is(":focus")){
vv.push($(_b7b).val());
}
return vv.join(",");
...
}}),tagFormatter:function(_b7d,row){
var opts=$(this).tagbox("options");
return row?row[opts.textField]:_b7d;
},tagStyler:function(_b7e,row){
return "";
},onClickTag:function(_b7f){
},onBeforeRemoveTag:function(_b80){
},onRemoveTag:function(_b81){
}});
})(jQuery);
(function($){
function _b82(_b83){
...
$(_b83).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_b85(this);
_b86(this);
_b87(this);
_b95(this,$(this).datebox("getText"),true);
opts.onShowPanel.call(this);
}}));
if(!_b84.calendar){
var _b88=$(_b83).combo("panel").css("overflow","hidden");
_b88.panel("options").onBeforeDestroy=function(){
var c=$(this).find(".calendar-shared");
if(c.length){
c.insertBefore(c[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner\"></div>").prependTo(_b88);
...
_b84.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_b84.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var _b89=this.target;
var opts=$(_b89).datebox("options");
_b95(_b89,opts.formatter.call(_b89,date));
$(_b89).combo("hidePanel");
opts.onSelect.call(_b89,date);
}});
}
$(_b83).combo("textbox").parent().addClass("datebox");
$(_b83).datebox("initValue",opts.value);
function _b85(_b8a){
var opts=$(_b8a).datebox("options");
var _b8b=$(_b8a).combo("panel");
_b8b.unbind(".datebox").bind("click.datebox",function(e){
if($(e.target).hasClass("datebox-button-a")){
var _b8c=parseInt($(e.target).attr("datebox-button-index"));
opts.buttons[_b8c].handler.call(e.target,_b8a);
}
});
};
function _b86(_b8d){
var _b8e=$(_b8d).combo("panel");
if(_b8e.children("div.datebox-button").length){
return;
}
var _b8f=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_b8e);
var tr=_b8f.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a class=\"datebox-button-a\" href=\"javascript:;\"></a>").html($.isFunction(btn.text)?btn.text(_b8d):btn.text).appendTo(td);
t.attr("datebox-button-index",i);
}
tr.find("td").css("width",(100/opts.buttons.length)+"%");
};
function _b87(_b90){
var _b91=$(_b90).combo("panel");
var cc=_b91.children("div.datebox-calendar-inner");
_b91.children()._outerWidth(_b91.width());
_b84.calendar.appendTo(cc);
_b84.calendar[0].target=_b90;
if(opts.panelHeight!="auto"){
var _b92=_b91.height();
_b91.children().not(cc).each(function(){
_b92-=$(this).outerHeight();
});
cc._outerHeight(_b92);
}
_b84.calendar.calendar("resize");
};
};
function _b93(_b94,q){
_b95(_b94,q,true);
};
function _b96(_b97){
var _b98=$.data(_b97,"datebox");
var opts=_b98.options;
var _b99=_b98.calendar.calendar("options").current;
if(_b99){
_b95(_b97,opts.formatter.call(_b97,_b99));
$(_b97).combo("hidePanel");
}
};
function _b95(_b9a,_b9b,_b9c){
var _b9d=$.data(_b9a,"datebox");
var opts=_b9d.options;
var _b9e=_b9d.calendar;
_b9e.calendar("moveTo",opts.parser.call(_b9a,_b9b));
if(_b9c){
$(_b9a).combo("setValue",_b9b);
}else{
if(_b9b){
_b9b=opts.formatter.call(_b9a,_b9e.calendar("options").current);
}
$(_b9a).combo("setText",_b9b).combo("setValue",_b9b);
}
};
$.fn.datebox=function(_b9f,_ba0){
if(typeof _b9f=="string"){
var _ba1=$.fn.datebox.methods[_b9f];
if(_ba1){
...
_b9f=_b9f||{};
return this.each(function(){
var _ba2=$.data(this,"datebox");
if(_ba2){
$.extend(_ba2.options,_b9f);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_b9f)});
}
_b82(this);
});
};
...
return $.extend($.data(jq[0],"datebox").options,{width:_ba3.width,height:_ba3.height,originalValue:_ba3.originalValue,disabled:_ba3.disabled,readonly:_ba3.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
$(this).combo("cloneFrom",from);
...
},initValue:function(jq,_ba4){
return jq.each(function(){
var opts=$(this).datebox("options");
var _ba5=opts.value;
if(_ba5){
_ba5=opts.formatter.call(this,opts.parser.call(this,_ba5));
}
$(this).combo("initValue",_ba5).combo("setText",_ba5);
});
},setValue:function(jq,_ba6){
return jq.each(function(){
_b95(this,_ba6);
});
},reset:function(jq){
...
$.fn.datebox.parseOptions=function(_ba7){
return $.extend({},$.fn.combo.parseOptions(_ba7),$.parser.parseOptions(_ba7,["sharedCalendar"]));
};
...
_b93(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_ba8){
return $(_ba8).datebox("options").currentText;
},handler:function(_ba9){
var now=new Date();
$(_ba9).datebox("calendar").calendar({year:now.getFullYear(),month:now.getMonth()+1,current:new Date(now.getFullYear(),now.getMonth(),now.getDate())});
_b96(_ba9);
}},{text:function(_baa){
return $(_baa).datebox("options").closeText;
},handler:function(_bab){
...
(function($){
function _bac(_bad){
var _bae=$.data(_bad,"datetimebox");
var opts=_bae.options;
$(_bad).datebox($.extend({},opts,{onShowPanel:function(){
var _baf=$(this).datetimebox("getValue");
_bb5(this,_baf,true);
opts.onShowPanel.call(this);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_bad).removeClass("datebox-f").addClass("datetimebox-f");
$(_bad).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(this.target,date);
}});
if(!_bae.spinner){
var _bb0=$(_bad).datebox("panel");
var p=$("<div style=\"padding:2px\"><input></div>").insertAfter(_bb0.children("div.datebox-calendar-inner"));
_bae.spinner=p.children("input");
}
_bae.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator});
$(_bad).datetimebox("initValue",opts.value);
};
function _bb1(_bb2){
var c=$(_bb2).datetimebox("calendar");
var t=$(_bb2).datetimebox("spinner");
...
var date=_bb1(_bb7);
_bb5(_bb7,opts.formatter.call(_bb7,date));
$(_bb7).combo("hidePanel");
};
function _bb5(_bb8,_bb9,_bba){
var opts=$.data(_bb8,"datetimebox").options;
$(_bb8).combo("setValue",_bb9);
if(!_bba){
if(_bb9){
var date=opts.parser.call(_bb8,_bb9);
$(_bb8).combo("setText",opts.formatter.call(_bb8,date));
$(_bb8).combo("setValue",opts.formatter.call(_bb8,date));
}else{
$(_bb8).combo("setText",_bb9);
}
}
var date=opts.parser.call(_bb8,_bb9);
$(_bb8).datetimebox("calendar").calendar("moveTo",date);
$(_bb8).datetimebox("spinner").timespinner("setValue",_bbb(date));
function _bbb(date){
function _bbc(_bbd){
return (_bbd<10?"0":"")+_bbd;
};
var tt=[_bbc(date.getHours()),_bbc(date.getMinutes())];
if(opts.showSeconds){
tt.push(_bbc(date.getSeconds()));
}
return tt.join($(_bb8).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_bbe,_bbf){
if(typeof _bbe=="string"){
var _bc0=$.fn.datetimebox.methods[_bbe];
if(_bc0){
return _bc0(this,_bbf);
}else{
return this.datebox(_bbe,_bbf);
}
}
_bbe=_bbe||{};
return this.each(function(){
var _bc1=$.data(this,"datetimebox");
if(_bc1){
$.extend(_bc1.options,_bbe);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_bbe)});
}
_bac(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _bc2=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_bc2.originalValue,disabled:_bc2.disabled,readonly:_bc2.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_bc3){
return jq.each(function(){
var opts=$(this).datetimebox("options");
var _bc4=opts.value;
if(_bc4){
_bc4=opts.formatter.call(this,opts.parser.call(this,_bc4));
}
$(this).combo("initValue",_bc4).combo("setText",_bc4);
});
},setValue:function(jq,_bc5){
return jq.each(function(){
_bb5(this,_bc5);
});
},reset:function(jq){
...
$.fn.datetimebox.parseOptions=function(_bc6){
var t=$(_bc6);
return $.extend({},$.fn.datebox.parseOptions(_bc6),$.parser.parseOptions(_bc6,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_bb3(this,q);
}},buttons:[{text:function(_bc7){
return $(_bc7).datetimebox("options").currentText;
},handler:function(_bc8){
var opts=$(_bc8).datetimebox("options");
_bb5(_bc8,opts.formatter.call(_bc8,new Date()));
$(_bc8).datetimebox("hidePanel");
}},{text:function(_bc9){
return $(_bc9).datetimebox("options").okText;
},handler:function(_bca){
_bb6(_bca);
}},{text:function(_bcb){
return $(_bcb).datetimebox("options").closeText;
},handler:function(_bcc){
$(_bcc).datetimebox("hidePanel");
}}],formatter:function(date){
var h=date.getHours();
var M=date.getMinutes();
var s=date.getSeconds();
function _bcd(_bce){
return (_bce<10?"0":"")+_bce;
};
var _bcf=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_bcd(h)+_bcf+_bcd(M);
...
var tt=dt[1].split(_bd0);
var hour=parseInt(tt[0],10)||0;
var _bd1=parseInt(tt[1],10)||0;
var _bd2=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_bd1,_bd2);
}});
})(jQuery);
(function($){
function init(_bd3){
var _bd4=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_bd3);
var t=$(_bd3);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_bd4.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_bd4.bind("_resize",function(e,_bd5){
if($(this).hasClass("easyui-fluid")||_bd5){
_bd6(_bd3);
}
return false;
});
...
if(_bd8){
if(_bd8.width){
opts.width=_bd8.width;
}
if(_bd8.height){
opts.height=_bd8.height;
}
}
_bda._size(opts);
if(opts.mode=="h"){
_bda.css("height","");
_bda.children("div").css("height","");
}else{
_bda.css("width","");
_bda.children("div").css("width","");
_bda.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_bda._outerHeight());
}
_bdb(_bd7);
};
function _bdc(_bdd){
var _bde=$.data(_bdd,"slider");
var opts=_bde.options;
var _bdf=_bde.slider;
...
_be0(aa);
function _be0(aa){
var rule=_bdf.find("div.slider-rule");
var _be1=_bdf.find("div.slider-rulelabel");
rule.empty();
_be1.empty();
for(var i=0;i<aa.length;i++){
var _be2=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_be2);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_be1);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_be2,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_be2,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _be3(_be4){
var _be5=$.data(_be4,"slider");
var opts=_be5.options;
var _be6=_be5.slider;
_be6.removeClass("slider-h slider-v slider-disabled");
_be6.addClass(opts.mode=="h"?"slider-h":"slider-v");
_be6.addClass(opts.disabled?"slider-disabled":"");
var _be7=_be6.find(".slider-inner");
_be7.html("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_be7.append("<a href=\"javascript:;\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
_be6.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_be5.isDragging=true;
opts.onSlideStart.call(_be4,opts.value);
},onStopDrag:function(e){
_be9(opts.mode=="h"?e.data.left:e.data.top,this);
opts.onSlideEnd.call(_be4,opts.value);
opts.onComplete.call(_be4,opts.value);
_be5.isDragging=false;
}});
_be6.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_be5.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
_be9(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top));
opts.onComplete.call(_be4,opts.value);
});
function _be9(pos,_bea){
var _beb=_bec(_be4,pos);
var s=Math.abs(_beb%opts.step);
if(s<opts.step/2){
_beb-=s;
}else{
_beb=_beb-s+opts.step;
}
if(opts.range){
var v1=opts.value[0];
var v2=opts.value[1];
...
if(_bea){
var _bed=$(_bea).nextAll(".slider-handle").length>0;
if(_beb<=v2&&_bed){
v1=_beb;
}else{
if(_beb>=v1&&(!_bed)){
...
_beb<m?v1=_beb:v2=_beb;
}
}
}
$(_be4).slider("setValues",[v1,v2]);
}else{
$(_be4).slider("setValue",_beb);
}
};
};
function _bee(_bef,_bf0){
var _bf1=$.data(_bef,"slider");
var opts=_bf1.options;
var _bf2=_bf1.slider;
var _bf3=$.isArray(opts.value)?opts.value:[opts.value];
var _bf4=[];
if(!$.isArray(_bf0)){
_bf0=$.map(String(_bf0).split(opts.separator),function(v){
return parseFloat(v);
});
}
_bf2.find(".slider-value").remove();
var name=$(_bef).attr("sliderName")||"";
for(var i=0;i<_bf0.length;i++){
var _bf5=_bf0[i];
if(_bf5<opts.min){
_bf5=opts.min;
}
...
var _bf6=$("<input type=\"hidden\" class=\"slider-value\">").appendTo(_bf2);
_bf6.attr("name",name);
_bf6.val(_bf5);
_bf4.push(_bf5);
var _bf7=_bf2.find(".slider-handle:eq("+i+")");
var tip=_bf7.next();
var pos=_bf8(_bef,_bf5);
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_bef,_bf5));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _bf9="left:"+pos+"px;";
_bf7.attr("style",_bf9);
tip.attr("style",_bf9+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _bf9="top:"+pos+"px;";
_bf7.attr("style",_bf9);
tip.attr("style",_bf9+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
opts.value=opts.range?_bf4:_bf4[0];
$(_bef).val(opts.range?_bf4.join(opts.separator):_bf4[0]);
if(_bf3.join(",")!=_bf4.join(",")){
opts.onChange.call(_bef,opts.value,(opts.range?_bf3:_bf3[0]));
}
};
function _bdb(_bfa){
var opts=$.data(_bfa,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_bee(_bfa,opts.value);
opts.onChange=fn;
};
function _bf8(_bfb,_bfc){
var _bfd=$.data(_bfb,"slider");
var opts=_bfd.options;
var _bfe=_bfd.slider;
var size=opts.mode=="h"?_bfe.width():_bfe.height();
var pos=opts.converter.toPosition.call(_bfb,_bfc,size);
if(opts.mode=="v"){
pos=_bfe.height()-pos;
}
if(opts.reversed){
...
function _bec(_bff,pos){
var _c00=$.data(_bff,"slider");
var opts=_c00.options;
var _c01=_c00.slider;
var size=opts.mode=="h"?_c01.width():_c01.height();
var pos=opts.mode=="h"?(opts.reversed?(size-pos):pos):(opts.reversed?pos:(size-pos));
var _c02=opts.converter.toValue.call(_bff,pos,size);
return _c02.toFixed(0);
};
$.fn.slider=function(_c03,_c04){
if(typeof _c03=="string"){
return $.fn.slider.methods[_c03](this,_c04);
}
_c03=_c03||{};
return this.each(function(){
var _c05=$.data(this,"slider");
if(_c05){
$.extend(_c05.options,_c03);
}else{
_c05=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_c03),slider:init(this)});
$(this).removeAttr("disabled");
}
...
_bee(this,opts.range?[opts.min,opts.max]:[opts.min]);
});
},reset:function(jq){
return jq.each(function(){
var opts=$(this).slider("options");
...
$.fn.slider.parseOptions=function(_c09){
var t=$(_c09);
return $.extend({},$.parser.parseOptions(_c09,["width","height","mode",{reversed:"boolean",showTip:"boolean",range:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,range:false,value:0,separator:",",min:0,max:100,step:1,rule:[],tipFormatter:function(_c0a){
return _c0a;
},converter:{toPosition:function(_c0b,size){
var opts=$(this).slider("options");
return (_c0b-opts.min)/(opts.max-opts.min)*size;
},toValue:function(pos,size){
var opts=$(this).slider("options");
return opts.min+(opts.max-opts.min)*(pos/size);
}},onChange:function(_c0c,_c0d){
},onSlideStart:function(_c0e){
},onSlideEnd:function(_c0f){
},onComplete:function(_c10){
}};
})(jQuery);